...
public abstract class AbstractJMXGeneralStats<SS extends ServerStatus>
    ...
    /*
     * (non-Javadoc)
     * @see com.smexec.monitor.server.utils.IJMXGeneralStats#getMemoryStats(com.smexec.monitor.server.model.
    ...
    /*
     * (non-Javadoc)
     * @see com.smexec.monitor.server.utils.IJMXGeneralStats#getRuntimeInfo(com.smexec.monitor.server.model.
     * ServerStatus)
     */
    @Override
