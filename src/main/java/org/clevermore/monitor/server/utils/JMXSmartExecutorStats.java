...
import org.clevermore.monitor.shared.smartpool.TaskExecutionStats;
...
public class JMXSmartExecutorStats {
    ...
    public void getSmartThreadPoolStats(ServerStatus ss)
        ...
        ObjectName smartExecutors = new ObjectName("org.clevermore:type=SmartExecutor,name=*");
        ...
        ObjectName smartExecutor = new ObjectName("org.clevermore:type=SmartExecutor.Pools,name=*");
